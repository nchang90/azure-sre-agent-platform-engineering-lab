...
variable "azure_monitor_resource_id" {
  description = "Optional ARM resource ID for the Azure Monitor connector scope. Defaults to the S3 agent resource group when scenario = s3, otherwise the current subscription ID."
  type        = string
  default     = ""
