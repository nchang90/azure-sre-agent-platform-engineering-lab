...
az monitor metrics list --resource "/subscriptions/<subId>/resourceGroups/rg-sre-lab/providers/Microsoft.App/containerApps/orders-api" --metric "UsageNanoCores" --interval PT5M
```
...
# Example:
az containerapp show -g rg-sre-lab -n orders-api --output json
```
...
# Example:
az containerapp logs show -g rg-sre-lab -n orders-api --revision orders-api--0000003 --tail 300

# If command fails, retry with --format text:
az containerapp logs show -g rg-sre-lab -n orders-api --revision orders-api--0000003 --tail 300 --format text
```
...
```
Subject: [Incident INC0012345] HTTP 500 Error Analysis - orders-api

## Summary
- **App:** orders-api (Production)
