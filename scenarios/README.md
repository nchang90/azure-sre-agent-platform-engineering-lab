...
| S3 Change issue triage | `environments/demo.tfvars` or `environments/sbox.tfvars` | `bash scripts/apply-extras.sh <environment>` | Configure GitHub in Azure SRE Agent portal (only if needed) |
