...
- [S2 Web API Deployment Regression (Autonomous Remediation)](./s2-autonomous-remediation/)
...
| S2 Web API production deployment regression | `environments/sbox.tfvars` | `bash scripts/apply-extras.sh sbox` | Configure GitHub in Azure SRE Agent portal (only if needed) |
